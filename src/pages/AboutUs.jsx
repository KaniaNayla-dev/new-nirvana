    ...
    <div>
      ...
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex w-full h-full">
          <div className="flex w-full bg-blue-400 bg-cover bg-center h-full">
            <img
              src={about1}
              alt="About Image"
          ...
          <div className="flex flex-col w-full p-16 text-justify gap-y-6">
            <h2 className="text-xl font-bold text-[#3A55B4] underline underline-offset-8 ">
              {t("aboutus.about_1.title")}
            </h2>
            <h1 className=" text-gray-700 leading-8">
        ...
        <div className="flex w-full h-full">
          ...
          <div className="flex w-full text-white bg-cover bg-center h-full">
            <img
              src={about2}
              alt="About Image"
              className="w-full h-full object-cover"
